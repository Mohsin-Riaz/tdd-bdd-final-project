...
class TestProductRoutes(TestCase):
    ...
    def test_get_product(self):
        """Get a Product"""
        created = self._create_products(1)
        product = created[0]
        ...
        self.assertEqual(res["name"], product.name)

    def test_get_product_not_found(self):
        """Test product not found path"""
    ...
    def test_update_product(self):
        ...
        res = self.client.put(f"{BASE_URL}/{product_data['id']}", json=product_data)
        self.assertEqual(res.status_code, status.HTTP_200_OK)

        updated_product = res.get_json()
        self.assertEqual(updated_product["description"], "Updated Description")

    def test_delete_product(self):
        """Delete a Product"""
        products = self._create_products(5)
        first_count = self.get_product_count()
        ...
        second_count = self.get_product_count()
    ...
    def test_query_by_category(self):
        ...
        logging.debug("Found Products [%d] %s", count, category_items)
